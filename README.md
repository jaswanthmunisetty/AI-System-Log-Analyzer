...
🎯 Use Cases
Debug production logs quickly
DevOps monitoring tool
Learning system design & failure analysis
Resume project for AI / Backend / Full Stack roles
🔮 Future Improvements
MongoDB integration for scalable history
...
File-based storage (not scalable yet)
👨‍💻 Author
